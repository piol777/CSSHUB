    ...
    <div class="modal-overlay" id="createClassModal">
        <div class="modal-box">
            ...
            <form id="createClassForm" class="modal-form">
                ...
                <input type="text" id="classSubjectName" placeholder="e.g. Web Development" required maxlength="150">
                ...
                <input type="text" id="classSectionLabel" placeholder="e.g. 2-3" required maxlength="10">

                <label>Semester</label>
                <input type="text" id="classSemesterLabel" placeholder="e.g. 1st Semester 2025-2026" required maxlength="50">
                ...
                <button type="submit" class="modal-submit-btn">Create Class</button>
            </form>
        </div>
    </div>
